...
#        --transient "{\"car\":\"$CAR\"}"
	...
	-c '{"function": "Register_NFT","Args":["testtesttest", "initial_balancd","initial_timestamp","initial_tokenuri","initial_tokenid","initial_minter","initial_fcn","initial_title","initial_category","initial_nft_num","initial_nft_status"]}'
